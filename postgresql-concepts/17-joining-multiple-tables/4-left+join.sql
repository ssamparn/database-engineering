...
-- Note: Reversing the order of the tables in a LEFT JOIN generally changes the result set, because the query returns all rows from the left table and only matching rows from the right table.
